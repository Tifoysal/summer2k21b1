            ...
            <div class="container-fluid" style=" background-color: #fff; padding: 11px;">
                <div class="row">
                    <div class="col-lg-2 order-lg-1 order-2">
                        <ul class="image_list">
                            <li data-image="https://i.imgur.com/21EYMGD.jpg"><img src="{{url('/uploads/'.$product->image)}}" alt=""></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-6 order-3">
                        <div class="product_description">
                            ...
                            <div> <span class="product_price">BDT {{$product->price}}</span>
{{--                                <strike class="product_discount"> <span style='color:black'>₹ 2,000<span> </strike> --}}
                            </div>

                            <hr class="singleline">
                            <div> <span class="product_info">{{$product->description}}</span> </div>
                            <div>
                        ...
                        <div class="col-sm-3">
                            <a href="{{route('product.view',$product->id)}}">
                                ...
                                <div class="best_shoes">
                                    ...
                                    <div class="shoes_icon"><img width="150px" src="{{url('uploads/'.$product->image)}}"></div>
                                    <div class="star_text">
                                        <div class="left_part">

                                        </div>
                                        <div class="right_part">
                                            <div><a href="" class="btn btn-primary">Add to cart</a></div>
